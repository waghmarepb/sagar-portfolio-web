...
export const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      className="w-full h-[24rem] sm:h-[26rem] md:h-[28rem] relative overflow-hidden rounded-lg shadow-lg border border-[#2A0E61] bg-gradient-to-br from-[#0c0c1d] to-[#111132] group flex flex-col"
    >
      <Link
        href={link}
        target="_blank"
