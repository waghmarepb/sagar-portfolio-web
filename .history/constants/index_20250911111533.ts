...
export const ANDROID_PROJECTS = [
  {
    ...
    description: "Complete shopping platform with payment gateway integration, real-time inventory management, and GST calculation. Features include user authentication, product catalog, shopping cart, order tracking, and admin dashboard.",
    image: "/projects/android-project/eccomerece.jpg",
    link: "https://github.com/sagarkumbhar",
    tech: ["Flutter", "Dart", "Firebase", "Stripe", "Razorpay", "GST API"]
  },
  {
  ...
  {
    title: "📚 PLAB Study App",
    description: "Comprehensive medical study platform for PLAB exam preparation with interactive quizzes, progress tracking, AI-powered recommendations, and offline study materials. Features include mock tests and performance analytics.",
    image: "/projects/android-project/plab.jpg",
    link: "https://github.com/sagarkumbhar",
    tech: ["Flutter", "Dart", "AI/ML", "Local Database", "Offline Mode", "Analytics"]
  },
  {
