    ...
    <nav className="fixed top-0 left-0 w-full bg-[#03001427] backdrop-blur-md shadow-lg shadow-[#2A0E61]/50 z-50">
      <div className="flex items-center justify-between h-[70px] px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          />
          <span className="hidden sm:block text-white font-bold tracking-wide text-xs lg:text-sm whitespace-nowrap">
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <Link 
              ...
              rel="noopener noreferrer"
              onClick={closeMenu}
              className="bg-gradient-to-r from-purple-500 to-cyan-500 text-white px-4 py-2 rounded-full font-semibold hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-purple-500/25 mt-6 text-sm"
            >
              📄 Resume
            </Link>
