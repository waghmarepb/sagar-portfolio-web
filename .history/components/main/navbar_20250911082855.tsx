  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-[#03001427] backdrop-blur-md shadow-lg shadow-[#2A0E61]/50 z-50">
      <div className="flex items-center justify-between h-[70px] px-5 md:px-8 lg:px-12 max-w-7xl mx-auto">
        ...
        {/* Desktop Navigation */}
        <div className="hidden lg:flex items-center gap-6 xl:gap-8 bg-[rgba(3,0,20,0.37)] px-6 xl:px-8 py-2 rounded-full border border-[rgba(112,66,248,0.38)] text-gray-200">
          {NAV_LINKS.map((link) => (
            <Link 
              key={link.title} 
              href={link.link} 
