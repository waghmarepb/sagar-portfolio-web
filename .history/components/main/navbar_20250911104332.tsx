      ...
      <div className="flex items-center justify-between h-[70px] px-5 md:px-8 lg:px-12 max-w-7xl mx-auto">
        ...
        >
          ...
          <span className="hidden sm:block text-white font-bold tracking-wide">
            Sagar Kumbhar | Flutter Developer
          </span>
        </Link>

        {/* Desktop Navigation */}
        <div className="hidden lg:flex items-center gap-4 xl:gap-6 bg-[rgba(3,0,20,0.37)] px-6 xl:px-8 py-2 rounded-full border border-[rgba(112,66,248,0.38)] text-gray-200">
          {NAV_LINKS.map((link) => (
            <Link 
              key={link.title} 
              href={link.link} 
              className="hover:text-[rgb(112,66,248)] transition font-medium flex items-center gap-2 px-3 py-1 rounded-lg hover:bg-[rgba(112,66,248,0.1)]"
            >
        ...
        <div className="hidden lg:flex items-center gap-4 xl:gap-5">
          ...
          <Link 
            ...
            className="bg-gradient-to-r from-purple-500 to-cyan-500 text-white px-4 py-2 rounded-full font-semibold hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-purple-500/25"
          >
            📄 Resume
          </Link>
