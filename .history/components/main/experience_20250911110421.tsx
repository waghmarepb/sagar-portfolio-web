  ...
  projects: [
    {
      ...
      apps: [
        { name: "E-Commerce App", features: ["Payment Integration", "Real-time Inventory", "GSTIN Integration"], icon: "💳" },
    ...
    },
    {
      ...
      apps: [
        ...
        { name: "PLAB App", features: ["Study Materials", "Progress Tracking", "AI Tutoring"], icon: "📚" }
      ]
    },
    {
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.p
            ...
            className="text-gray-300 text-xl max-w-4xl mx-auto mt-8 leading-relaxed"
          >
        ...
        >
          {Object.entries(experienceData.overview).map(([key, value], index) => (
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-[#0c0c1d] to-[#111132] p-8 rounded-2xl border border-purple-500/30 group-hover:border-purple-500/60 transition-all duration-300 backdrop-blur-sm">
                <motion.div
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {Object.entries(experienceData.technologies).map(([category, techs], index) => (
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-[#0c0c1d] to-[#111132] p-6 rounded-xl border border-purple-500/30 group-hover:border-purple-500/60 transition-all duration-300 backdrop-blur-sm">
                  <h3 className="text-lg font-semibold text-purple-400 mb-4 capitalize flex items-center">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {techs.map((tech, techIndex) => (
                      <motion.span
                        ...
                        className="px-3 py-1 text-xs bg-gradient-to-r from-purple-500/20 to-cyan-500/20 text-purple-300 rounded-full border border-purple-500/30 hover:border-purple-500/60 transition-all duration-300"
                      >
                        {tech}
                      </motion.span>
                    ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {experienceData.achievements.map((achievement, index) => (
              ...
              >
                ...
                <div className="relative flex items-center bg-gradient-to-r from-purple-500/10 to-cyan-500/10 p-6 rounded-xl border border-purple-500/30 group-hover:border-purple-500/60 transition-all duration-300 backdrop-blur-sm">
                  <motion.span
