          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {Object.entries(experienceData.technologies).map(([category, techs], index) => (
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-[#0c0c1d] to-[#111132] p-6 rounded-xl border border-purple-500/30 group-hover:border-purple-500/60 transition-all duration-300 backdrop-blur-sm h-full flex flex-col">
