...
const TechIcon = ({ position, children, color = "#7D43FF" }: { position: [number, number, number], children: string, color?: string }) => {
  ...
  return (
    <Float speed={2} rotationIntensity={1} floatIntensity={0.5}>
      <Box ref={meshRef} position={position} args={[1, 1, 0.1]}>
...
const FloatingParticles = () => {
  ...
  return (
    <points ref={points}>
      ...
      <pointsMaterial size={0.02} color="#7D43FF" transparent opacity={0.6} />
    </points>
  );
};
